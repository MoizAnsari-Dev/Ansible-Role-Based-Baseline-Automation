# Ansible Role-Based Baseline Server Automation - User Manual
...
### AWS Credentials
Since this project uses AWS Dynamic Inventory, you must have your AWS credentials configured securely or passed via environment variables. By default, it uses `/home/moiz/Downloads/Windows1.pem` as specified in `ansible.cfg`.

Make sure your AWS SSH Key has the correct permissions:
```bash
chmod 400 /home/moiz/Downloads/Windows1.pem
```
...
- **Private Key**: Configured to `/home/moiz/Downloads/Windows1.pem`.
...
- **`Permission denied (publickey)`**: Ensure your `.pem` key file is located exactly at `/home/moiz/Downloads/Windows1.pem` and its permissions are locked down (`chmod 400`).
